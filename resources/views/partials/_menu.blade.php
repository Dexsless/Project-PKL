<div class="sidebar__menu-group">
    <ul class="sidebar_nav">
        <li>
            <a href="{{ route('dashboard.demo_one',app()->getLocale()) }}" class="{{ Request::is(app()->getLocale().'/dashboards') ? 'active':'' }}">
                <span class="nav-icon uil uil-create-dashboard"></span>
                <span class="menu-text">{{ trans('menu.dashboard-menu-title') }}</span>
            </a>
        </li>
        <li>
            <a href="{{route('tabungan.index',app()->getLocale())}}" class="{{ Request::is(app()->getLocale().'/tabungan') ? 'active':'' }}">
        ...
        <li>
            <a href="{{ route('changelog',app()->getLocale()) }}" class="{{ Request::is(app()->getLocale().'/changelog') ? 'active':'' }}">
                ...
                <span class="menu-text">Grafik Keuangan</span>
            </a>
        </li>
        <li>
